...
| `aristoteles_rembrandt.jpg` | Aristoteles mit einer Büste Homers | Rembrandt | 1653 | Antike · Bild der Zeit |
...
| Datei | Werk | Quelle | Jahr | Symbolisiert |
|---|---|---|---|---|
...
mit Genehmigung des Urhebers im Projekt verwendet wird. Die NASA-Bilder sind als
Werke einer US-Bundesbehörde gemeinfrei.
