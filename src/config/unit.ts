      ...
      submodules: [
        {
          ...
          subtitle: "Auftakt",
          description:
            "Mit KI tritt eine neue Art von Akteurin auf die Bühne, weder Werkzeug noch Person. Du gehst ihrer Geschichte nach, deckst ihre Merkmale auf und gewichtest, wie deutlich jedes sie ausmacht, wanderst durch Bilder von der Turing-Bombe bis DALL·E und stellst sie in ihre vier Kontexte: technisch, wirtschaftlich, rechtlich, kulturell.",
        },
        {
