...
const station1: Station = {
    ...
    quizPool: [
      ...
      },
      {
        ...
        optionen: [
          ...
          },
          {
            ...
            feedback:
              "Falsch. Keine seriöse BIP-Schätzung kommt auf +25% über 10 Jahre, und «alle einig» ist falsch — der Dissens zwischen Daron Acemoglu und Goldman Sachs ist fundamental.",
          },
        ],
        correctIndices: [1],
      },
      ...
      },
      {
        ...
        feedbackFalsch:
          "Falsch. Die Forschung ist alles andere als einig. Nobelpreisträger Daron Acemoglu (MIT) hält die BIP-Gewinne für minimal; Goldman Sachs sieht sie als riesig. Die Spannweite zeigt, wie unsicher die Datenlage ist.",
      },
    ] satisfies QuizPool,
