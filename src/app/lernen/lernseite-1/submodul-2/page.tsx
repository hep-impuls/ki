...
export default function Lernseite1Submodul2() {
  return (
    <AppLayout>
      <ActivityTracker
        type="lesson_open"
        page="lernseite-1/submodul-2"
        lessonId="lernseite-1-submodul-2"
      />
