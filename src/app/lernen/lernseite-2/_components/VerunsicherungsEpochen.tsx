...
const EPOCHEN: Epoche[] = [
  {
    ...
    technologie: {
      ...
      mehr: "Mit der Schrift lassen sich Gesetze, Verträge und Argumente festhalten und überprüfen. Das ist die Grundlage von Recht und Wissenschaft. Münzgeld beschleunigt Handel und Arbeitsteilung und lässt eine bewegliche Schicht von Kaufleuten neben dem alten Grundbesitz entstehen.",
      quellen: [
    ...
    verunsicherung: {
      ...
      mehr: "Wenn sich alles «weg­reden» lässt, wächst die Angst, dass gar nichts mehr gilt. Sokrates wurde wegen «Verderbnis der Jugend» und «Gottlosigkeit» angeklagt. Im Kern geschah das, weil sein unermüdliches Fragen die Gewissheiten der Bürger erschütterte.",
      quellen: [
    ...
    philosophie: {
      ...
      mehr: "Aristoteles' Schriften zur Logik («Organon») blieben bis ins 19. Jahrhundert massgeblich. Seine Trennung von Beobachtung und Begründung ist bis heute das Grundgerüst wissenschaftlichen Arbeitens. Es ist auch der Grund, warum wir Quellen und Belege verlangen.",
      quellen: [
  ...
  },
  {
    ...
    philosophie: {
      ...
      mehr: "Augustinus macht das Innenleben zum philosophischen Thema. Seine «Confessiones» («Bekenntnisse») gelten als erste grosse Autobiografie der Weltliteratur. Aus dem äusseren Reich wird das innere. Es ist eine Schablone, die dem lateinischen Europa fast tausend Jahre Orientierung gab.",
      quellen: [
  ...
  },
  {
    ...
    technologie: {
      ...
      mehr: "Die genaue Uhr taktet zunehmend Arbeit, Handel und Alltag. Und die Enzyklopädie von Diderot und d'Alembert (ab 1751) bündelt das Wissen der Zeit in geordneter, allgemein zugänglicher Form. Sie ist ein Leitprojekt der Aufklärung.",
      quellen: [
  ...
  },
  {
    ...
    verunsicherung: {
      ...
      mehr: "Kirchner malt sich 1915 als Soldat mit abgeschnittener Malhand, ein Sinnbild der seelischen Versehrung. Nussbaum zeigt sich um 1943 mit dem Stempel im Judenpass, kurz bevor er in Auschwitz ermordet wird: der Mensch, dem das Menschsein amtlich aberkannt wird.",
      quellen: [
  ...
  },
  {
    ...
    technologie: {
      ...
      mehr: "Mit dem Ende des Kalten Krieges wird der Markt zum Leitprinzip fast überall. Der Politikwissenschaftler Francis Fukuyama spricht 1992 vom «Ende der Geschichte». Er sieht die liberale Demokratie als Endpunkt. Rückblickend begann stattdessen ein neuer Umbruch: Globalisierung und Digitalisierung.",
      quellen: [
