...
const EPOCHEN: Epoche[] = [
  ...
  },
  {
    ...
    verunsicherung: {
      text: "Besonders getroffen werden Handwerker und Weber, deren Können die Maschine entwertet, und die Landbevölkerung, die in Elendsquartieren der Städte landet. Kinder arbeiten in Fabriken und Bergwerken. In England zerschlagen Weber ab 1811 in einer Protestbewegung die Maschinen, die sie arbeitslos machen (die «Ludditen»). 1848 entlädt sich die Spannung in einer Revolutionswelle quer durch Europa.",
  ...
  },
  {
    ...
    verunsicherung: {
      text: "Betroffen sind die junge Generation (ihre Klimazukunft), die Wissens- und Kreativberufe (durch KI) und der globale Süden, der die Folgen der Erwärmung am härtesten trägt. Und erstmals stehen ausdrücklich auch nicht-menschliche Akteure im Blick: Arten, das Klima und Ökosysteme, die nicht mitreden können.",
