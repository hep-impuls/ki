...
const BAUSTEINE = [
  {
    ...
    gewFrage: "Was hältst du von dieser Technologie?",
    gewStufen: [
  ...
  },
  {
    ...
    gewFrage: "Verunsichert dich das noch heute?",
  ...
  },
  {
    ...
    gewFrage: "Wie geht es dir mit dieser Sichtweise?",
    gewStufen: [
...
const EPOCHEN: Epoche[] = [
  {
        ...
        tour: [
          {
            ...
            text: "Raffael malt 1509–1511 im Vatikan eine ideale Halle, in der sich die Denker aller Zeiten begegnen. Es ist kein realer Ort und keine reale Szene, sondern ein Bild des Denkens selbst. Es ist die Antike, wie die Renaissance sie als ihr eigenes Fundament verehrte.",
          },
          {
    ...
    technologie: {
      ...
      quellen: [
        ...
        { label: "Linearschrift B (Wikipedia)", url: w("Linearschrift_B") },
        { label: "Dunkle Jahrhunderte (Wikipedia)", url: w("Dunkle_Jahrhunderte_(Antike)") },
        { label: "Altgriechische Münzen (Wikipedia)", url: w("Altgriechische_Münzen") },
        { label: "Hacksilber (Wikipedia)", url: w("Hacksilber") },
                ...
                return (
                  <li key={ti} className="scroll-mt-24">
                    ...
                    >
                      ...
                      >
                        {/* Nach dem Öffnen ein Haken statt des Bausteins-Symbols,
                            gleiches Muster wie bei den Kriterien in «Vorhang auf».
                            Welcher Baustein es ist, sagt der Titel daneben. */}
