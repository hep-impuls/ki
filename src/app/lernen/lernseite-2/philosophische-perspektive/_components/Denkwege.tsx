...
const BEREICHE: Bereich[] = [
  {
    ...
    absatzBegriffe: [
      ...
      { wort: "John Rawls", erklaerung: "US-amerikanischer politischer Philosoph, 1921 bis 2002; Hauptwerk «Eine Theorie der Gerechtigkeit» (1971)." },
      ...
      { wort: "Emmanuel Levinas", erklaerung: "Französischer Philosoph litauischer Herkunft, 1906 bis 1995; Hauptwerk «Totalität und Unendlichkeit» (1961)." },
    ...
    werk: "Aristoteles, «Metaphysik»; Immanuel Kant, «Logik» (1800); G. W. F. Hegel, «Phänomenologie des Geistes» (1807); Hannah Arendt, «Vita activa»; John Rawls, «Eine Theorie der Gerechtigkeit» (1971); Martin Heidegger, «Sein und Zeit» (1927); Emmanuel Levinas, «Totalität und Unendlichkeit» (1961); Peter Sloterdijk, «Du musst dein Leben ändern» (2009); Siri Hustvedt, «Die Illusion der Gewissheit» (2018)",
  },
  {
