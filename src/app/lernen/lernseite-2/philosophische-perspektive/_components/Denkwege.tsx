    ...
    denker: [
      ...
      },
      {
        ...
        begriffe: [
          ...
          { wort: "bestimmte Negation", erklaerung: "Hegels Wort dafür, an einer Sache zu unterscheiden, was hält und was nicht, statt sie im Ganzen zu verwerfen. Marx und später Adorno bauten darauf auf." },
        ],
      },
      {
        slug: "arendt",
