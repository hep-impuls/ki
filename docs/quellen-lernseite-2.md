# Quellen · Lernseite 2 «Eine ganz neue Partnerschaft»
...
- **Kennung:** `PP-52d713` (Vertiefung «Mehr lesen»)
...
- **Kennung:** `PP-74bda0` (Vertiefung «Mehr lesen»)
...
- **Kennung:** `PP-0294b1` (Vertiefung «Mehr lesen»)
...
- **Kennung:** `PP-4d58a4` (Vertiefung «Mehr lesen»)
...
- **Kennung:** `PP-002f10` (Vertiefung «Mehr lesen»)
...
- **Kennung:** `PP-0c7324` (Vertiefung «Mehr lesen»)
...
- **Kennung:** `PP-dca913` (Vertiefung «Mehr lesen»)
...
- **Kennung:** `PP-a0320e` (Vertiefung «Mehr lesen»)
...
- **Kennung:** `PP-3c0394` (Vertiefung «Mehr lesen»)
...
- **Kennung:** `PP-28bc86` (Vertiefung «Mehr lesen»)
...
- **Kennung:** `PP-815d58` (Vertiefung «Mehr lesen»)
...
- **Kennung:** `PP-b6b641` (Vertiefung «Mehr lesen»)
...
- **Kennung:** `PP-72d801` (Vertiefung «Mehr lesen»)
...
- **Kennung:** `PP-dea58d` (Vertiefung «Mehr lesen»)
...
- **Kennung:** `PP-0ca4a1` (Vertiefung «Mehr lesen»)
...
- **Kennung:** `PP-3e54ff` (Vertiefung «Mehr lesen»)
- **Quelle:** [Transatlantisches Telegrafenkabel (Wikipedia)](https://de.wikipedia.org/wiki/Transatlantisches_Telegrafenkabel)
...
### Kabel verbinden die Kontinente · rund 250 Terabit pro Sekunde

- **Kennung:** `PP-3e54ff` (Vertiefung «Mehr lesen»)
- **Quelle:** [Dunant (Seekabel) (Wikipedia)](https://de.wikipedia.org/wiki/Dunant_(Seekabel))
- **Fundstelle:** Das Kabel wurde «im September 2020 in Betrieb genommen», hat «zwölf Glasfaserpaare» und der Artikel nennt «knack 250 Terabit pro Sekunde» (so im Original, gemeint ist offenkundig knapp). Die englische Ausgabe schreibt «The design capacity is 250 terabits per second», darum steht im Text «rund 250 Terabit pro Sekunde». Pro Faserpaar sind das gut zwanzig Terabit, also ein Vielfaches der älteren Angabe im Seekabel-Artikel.
- **Geprüft:** 2026-08-17
...
- **Fundstelle:** «2014 wurden 95 Prozent des Internetverkehrs zwischen Weltregionen via Unterseekabel übertragen.» Der Artikel schreibt auch, «neueste Faserpaare können gut ein Terabit Daten pro Sekunde übertragen». Dieser Satz stand bis zum 17.8.2026 fast wörtlich im Text, ein Review hat ihn zu Recht als untertrieben gemeldet. Die Angabe gehört zum Stand der 2014er-Zahlen dieses Artikels, darum nennt der Text jetzt ein konkretes neueres Kabel.
- **Geprüft:** 2026-08-16
...
- **Kennung:** `PP-a07b95` (Vertiefung «Mehr lesen»)
- **Quelle:** [Geschichte des Hörfunks (Wikipedia)](https://de.wikipedia.org/wiki/Geschichte_des_H%C3%B6rfunks)
...
- **Kennung:** `PP-31331c` (Vertiefung «Mehr lesen»)
- **Quelle:** [Bibliothek von Alexandria (Wikipedia)](https://de.wikipedia.org/wiki/Bibliothek_von_Alexandria)
...
- **Kennung:** `PP-d7e5e9` (Vertiefung «Mehr lesen»)
...
### Selbstbestimmte Liebe · Die Niederlande öffneten

- **Kennung:** `PP-d7e5e9` (Vertiefung «Mehr lesen»)
- **Quelle:** [Gleichgeschlechtliche Ehe (Wikipedia)](https://de.wikipedia.org/wiki/Gleichgeschlechtliche_Ehe)
- **Fundstelle:** Die Niederlande stehen als erstes Land in der Länderliste, Datum «1. Apr. 2001». Der Artikel führt derzeit 39 Staaten mit geöffneter Ehe. Diese Zahl steht bewusst nicht im Lernset-Text, sie veraltet mit jedem weiteren Land.
- **Geprüft:** 2026-08-16

> Die Niederlande öffneten am 1. April 2001 als erstes Land der Welt die Ehe für gleichgeschlechtliche Paare. In der Schweiz sagten die Stimmenden am 26. September 2021 mit 64,1 Prozent Ja zur Ehe für alle und kein einziger Kanton lehnte ab; heiraten können gleichgeschlechtliche Paare hier seit dem 1. Juli 2022. Zwischen jener Nacht in der Christopher Street und diesem Abstimmungssonntag liegen zweiundfünfzig Jahre, ungefähr ein Menschenleben.

### Selbstbestimmte Liebe · seit dem 1. Juli 2022

- **Kennung:** `PP-d7e5e9` (Vertiefung «Mehr lesen»)
- **Quelle:** [Gleichgeschlechtliche Ehe (Wikipedia)](https://de.wikipedia.org/wiki/Gleichgeschlechtliche_Ehe)
- **Fundstelle:** Für die Schweiz nennt der Artikel den 1. Juli 2022 als Datum, seit dem gleichgeschlechtliche Paare heiraten können. Die Abstimmung vom 26. September 2021 steht damit nicht ohne ihr Inkrafttreten da.
- **Geprüft:** 2026-08-16

> Die Niederlande öffneten am 1. April 2001 als erstes Land der Welt die Ehe für gleichgeschlechtliche Paare. In der Schweiz sagten die Stimmenden am 26. September 2021 mit 64,1 Prozent Ja zur Ehe für alle und kein einziger Kanton lehnte ab; heiraten können gleichgeschlechtliche Paare hier seit dem 1. Juli 2022. Zwischen jener Nacht in der Christopher Street und diesem Abstimmungssonntag liegen zweiundfünfzig Jahre, ungefähr ein Menschenleben.

### Afrikas Bibliotheken · vor 1100 gegründet

- **Kennung:** `PP-664b4c` (Kartentext)
- **Quelle:** [Timbuktu (Wikipedia)](https://de.wikipedia.org/wiki/Timbuktu)
- **Fundstelle:** Nach den Chroniken von Timbuktu wurde die Stadt «vor dem Jahr 1100 n. Chr. von nomadisierenden Massufa-Tuareg an einer Wasserstelle gegründet», vermutlich gehen die Ursprünge bis ins 9. oder 10. Jahrhundert zurück. Der wirtschaftliche Aufschwung und die kulturelle Blüte fallen ins 14. und 15. Jahrhundert.
- **Geprüft:** 2026-08-17

> Wissen sammeln, ordnen und weitergeben ist eine Praxis, die in Afrika lange vor der europäischen Universität blühte. In Alexandria stand die bedeutendste antike Bibliothek, sie sollte alle Wissensgebiete abdecken. Timbuktu, vor 1100 gegründet, wurde ab dem 14. Jahrhundert zur Gelehrtenstadt, an der Sankoré-Moschee lehrte man Sprache, Rhetorik, Astrologie und Rechtsprechung. Gesammelt wurde aus Gelehrsamkeit, als Familienerbe und als Geschäft. Das Bild vom schriftlosen Afrika war immer falsch.

### Afrikas Bibliotheken · vor dem Jahr 1100

- **Kennung:** `PP-31331c` (Vertiefung «Mehr lesen»)
- **Quelle:** [Timbuktu (Wikipedia)](https://de.wikipedia.org/wiki/Timbuktu)
- **Fundstelle:** Gründung «vor dem Jahr 1100 n. Chr.» an einer Wasserstelle; unter der Herrschaft der Songhai hatte die Stadt «geschätzte 15.000 bis 25.000 Einwohner». Der Aufschwung kam mit dem Handel im 14. und 15. Jahrhundert.
- **Geprüft:** 2026-08-17

> Ptolemaios I. errichtete die Bibliothek von Alexandria vermutlich zwischen 290 und 282 v. Chr. und sie sollte alle Wissensgebiete umfassen; moderne Schätzungen sprechen von 400'000 bis 500'000 Rollen, umstritten sind diese Zahlen bis heute. Timbuktu wurde vor dem Jahr 1100 an einer Wasserstelle gegründet, der Aufschwung kam mit dem Handel im 14. und 15. Jahrhundert und unter der Herrschaft der Songhai lebten 15'000 bis 25'000 Menschen in der Stadt. An der Sankoré-Moschee stand «eine Madrasa, vergleichbar einer mittelalterlichen Universität», dazu kamen 150 bis 180 Koranschulen. Eigene Bibliotheken galten als Zeichen der Gelehrtenelite, Familien bewahrten die Bände über Jahrhunderte zu Hause auf und der Buchhandel blühte, Leo Africanus rühmte ihn nach seinem Besuch Anfang des 16. Jahrhunderts. Die Handschriften reichen vom späten 13. bis ins 20. Jahrhundert und handeln von Astronomie, Medizin, Recht und Poesie. Als 2012 Islamisten die Stadt besetzten, schmuggelten Bibliothekare die über 20'000 Manuskripte des Ahmed-Baba-Zentrums und zigtausende aus Privatbibliotheken ausser Landes, rund 350'000 wurden in Sicherheit gebracht. Seit 1988 gehört die Stadt zum UNESCO-Welterbe. Der Traum, alles Wissen an einem Ort zu haben, ist also alt und er lebt in den Datensammlungen weiter, aus denen eine KI heute lernt.

### Afrikas Bibliotheken · Leo Africanus

- **Kennung:** `PP-31331c` (Vertiefung «Mehr lesen»)
- **Quelle:** [Tombouctou Manuscripts Project, Universität Kapstadt (englisch)](https://tombouctoumanuscripts.uct.ac.za/overview/timbuktus-history)
- **Fundstelle:** Das Forschungsprojekt hält fest, Leo Africanus habe bei seinem Besuch Anfang des 16. Jahrhunderts ein glänzendes Bild des Buchhandels gezeichnet («a glowing account of the book trade»), und eigene Bibliotheken seien ein Kennzeichen der Gelehrtenelite gewesen. Eine deutschsprachige freie Quelle mit dieser Aussage haben wir nicht gefunden.
- **Geprüft:** 2026-08-17

> Ptolemaios I. errichtete die Bibliothek von Alexandria vermutlich zwischen 290 und 282 v. Chr. und sie sollte alle Wissensgebiete umfassen; moderne Schätzungen sprechen von 400'000 bis 500'000 Rollen, umstritten sind diese Zahlen bis heute. Timbuktu wurde vor dem Jahr 1100 an einer Wasserstelle gegründet, der Aufschwung kam mit dem Handel im 14. und 15. Jahrhundert und unter der Herrschaft der Songhai lebten 15'000 bis 25'000 Menschen in der Stadt. An der Sankoré-Moschee stand «eine Madrasa, vergleichbar einer mittelalterlichen Universität», dazu kamen 150 bis 180 Koranschulen. Eigene Bibliotheken galten als Zeichen der Gelehrtenelite, Familien bewahrten die Bände über Jahrhunderte zu Hause auf und der Buchhandel blühte, Leo Africanus rühmte ihn nach seinem Besuch Anfang des 16. Jahrhunderts. Die Handschriften reichen vom späten 13. bis ins 20. Jahrhundert und handeln von Astronomie, Medizin, Recht und Poesie. Als 2012 Islamisten die Stadt besetzten, schmuggelten Bibliothekare die über 20'000 Manuskripte des Ahmed-Baba-Zentrums und zigtausende aus Privatbibliotheken ausser Landes, rund 350'000 wurden in Sicherheit gebracht. Seit 1988 gehört die Stadt zum UNESCO-Welterbe. Der Traum, alles Wissen an einem Ort zu haben, ist also alt und er lebt in den Datensammlungen weiter, aus denen eine KI heute lernt.

### Afrikas Bibliotheken · über 20'000 Manuskripte

- **Kennung:** `PP-31331c` (Vertiefung «Mehr lesen»)
- **Quelle:** [SRF, 23. Mai 2018: «Wie drei Bibliothekare die Manuskripte von Timbuktu retteten»](https://www.srf.ch/kultur/gesellschaft-religion/wahrer-thriller-wie-drei-bibliothekare-die-manuskripte-von-timbuktu-retteten)
- **Fundstelle:** Im Ahmed-Baba-Zentrum lagerten «über 20'000 Manuskripte», dazu kamen «zigtausende weitere aus privaten Bibliotheken». Als Islamisten die Stadt besetzten, schafften Bibliothekare die Bestände in Metallkisten heimlich nach Bamako.
- **Geprüft:** 2026-08-17

> Ptolemaios I. errichtete die Bibliothek von Alexandria vermutlich zwischen 290 und 282 v. Chr. und sie sollte alle Wissensgebiete umfassen; moderne Schätzungen sprechen von 400'000 bis 500'000 Rollen, umstritten sind diese Zahlen bis heute. Timbuktu wurde vor dem Jahr 1100 an einer Wasserstelle gegründet, der Aufschwung kam mit dem Handel im 14. und 15. Jahrhundert und unter der Herrschaft der Songhai lebten 15'000 bis 25'000 Menschen in der Stadt. An der Sankoré-Moschee stand «eine Madrasa, vergleichbar einer mittelalterlichen Universität», dazu kamen 150 bis 180 Koranschulen. Eigene Bibliotheken galten als Zeichen der Gelehrtenelite, Familien bewahrten die Bände über Jahrhunderte zu Hause auf und der Buchhandel blühte, Leo Africanus rühmte ihn nach seinem Besuch Anfang des 16. Jahrhunderts. Die Handschriften reichen vom späten 13. bis ins 20. Jahrhundert und handeln von Astronomie, Medizin, Recht und Poesie. Als 2012 Islamisten die Stadt besetzten, schmuggelten Bibliothekare die über 20'000 Manuskripte des Ahmed-Baba-Zentrums und zigtausende aus Privatbibliotheken ausser Landes, rund 350'000 wurden in Sicherheit gebracht. Seit 1988 gehört die Stadt zum UNESCO-Welterbe. Der Traum, alles Wissen an einem Ort zu haben, ist also alt und er lebt in den Datensammlungen weiter, aus denen eine KI heute lernt.

### Afrikas Bibliotheken · rund 350'000

- **Kennung:** `PP-31331c` (Vertiefung «Mehr lesen»)
- **Quelle:** [Timbuktu Manuscripts (Wikipedia, englisch)](https://en.wikipedia.org/wiki/Timbuktu_Manuscripts)
- **Fundstelle:** «Some 350,000 manuscripts were transported to safety» (2012/2013). Die Handschriften wurden über Jahrhunderte in Privathäusern bewahrt («preserved in the homes of Timbuktu locals»), datieren «between the late 13th and the early 20th centuries» und behandeln unter anderem Medizin, Astronomie, Recht, Philosophie und Poesie. Einen deutschen Artikel gab es bei der Prüfung nicht.
- **Geprüft:** 2026-08-17
...
- **Fundstelle:** Eröffnung der Pearl Street Station am «4. September 1882», sechs Dampfmaschinen-Dynamos mit je 100 kW, zunächst 59 Abnehmer, «ein Jahr später waren es 513 Kunden». Die englische Wikipedia zählt anders, 82 Kunden mit 400 Lampen zum Start und 508 Kunden bis 1884. Weil die Ausgaben streiten, steht im Text «einige Dutzend Kunden» und «binnen zwei Jahren über 500», das deckt beide.
- **Geprüft:** 2026-08-17
...
### Elektrizität wird nutzbar · erste Magnetmaschinen

- **Kennung:** `PP-3342ef` (Vertiefung «Mehr lesen»)
- **Quelle:** [Elektrischer Generator (Wikipedia)](https://de.wikipedia.org/wiki/Elektrischer_Generator)
- **Fundstelle:** Hippolyte Pixii baute 1832 «den ersten bekannt gewordenen Wechselstromerzeuger» mit Hufeisenmagnet, ab 1849 fanden «Alliance»-Generatoren in der Industrie nennenswerten Einsatz.
- **Geprüft:** 2026-08-17

> Voltas Batterie war ein Stapel aus Kupfer- und Zinkplättchen, dazwischen lag Pappe, die mit einer leitenden Flüssigkeit getränkt war. Wegen dieser Schichtung heisst sie Voltasche Säule. Er entwickelte sie um 1799 und stellte sie 1800 der Royal Society in London vor, jahrzehntelang blieben solche Batterien die wichtigste Stromquelle für Forschung und Technik. Ab 1832 kamen erste Magnetmaschinen dazu und nachdem Werner von Siemens 1866 das dynamoelektrische Prinzip entdeckt hatte, lieferten Dynamos Strom in industriellen Mengen. Am 4. September 1882 eröffnete Edison in New York die Pearl Street Station, zuerst mit einigen Dutzend Kunden, binnen zwei Jahren waren es über 500. Danach stritten Gleich- und Wechselstrom um die Zukunft. Den Ausschlag gab 1891 ein Versuch, bei dem Drehstrom von Lauffen am Neckar über 176 Kilometer nach Frankfurt floss und drei Viertel der Energie ankamen. Kraftwerk und Verbraucher mussten von da an nicht mehr am selben Ort liegen. Die Schweiz nutzte ihr Wasser, 1879 nahm das Hotel Engadiner Kulm in St. Moritz die erste elektrische Beleuchtungsanlage des Landes in Betrieb. Bis etwa 1910 hatte das Land weltweit die höchste Stromproduktion pro Einwohner und 1939 waren 77 Prozent des Schienennetzes elektrifiziert, im übrigen Europa erst 5 Prozent. Google schätzte 2025 den Strom für eine mittlere Textanfrage an seine KI Gemini auf 0,24 Wattstunden, weniger als neun Sekunden Fernsehen. Gemessen hat das der Konzern selbst und das Training der Modelle kommt dazu.

### Elektrizität wird nutzbar · dynamoelektrische Prinzip

- **Kennung:** `PP-3342ef` (Vertiefung «Mehr lesen»)
- **Quelle:** [Elektrischer Generator (Wikipedia)](https://de.wikipedia.org/wiki/Elektrischer_Generator)
- **Fundstelle:** Werner von Siemens entdeckte 1866 das dynamoelektrische Prinzip; schon vor ihm hatten Ányos Jedlik 1851 und Søren Hjorth 1854 die Feldmagnete mit dem von der Maschine selbst erzeugten Strom gespeist.
- **Geprüft:** 2026-08-17

> Voltas Batterie war ein Stapel aus Kupfer- und Zinkplättchen, dazwischen lag Pappe, die mit einer leitenden Flüssigkeit getränkt war. Wegen dieser Schichtung heisst sie Voltasche Säule. Er entwickelte sie um 1799 und stellte sie 1800 der Royal Society in London vor, jahrzehntelang blieben solche Batterien die wichtigste Stromquelle für Forschung und Technik. Ab 1832 kamen erste Magnetmaschinen dazu und nachdem Werner von Siemens 1866 das dynamoelektrische Prinzip entdeckt hatte, lieferten Dynamos Strom in industriellen Mengen. Am 4. September 1882 eröffnete Edison in New York die Pearl Street Station, zuerst mit einigen Dutzend Kunden, binnen zwei Jahren waren es über 500. Danach stritten Gleich- und Wechselstrom um die Zukunft. Den Ausschlag gab 1891 ein Versuch, bei dem Drehstrom von Lauffen am Neckar über 176 Kilometer nach Frankfurt floss und drei Viertel der Energie ankamen. Kraftwerk und Verbraucher mussten von da an nicht mehr am selben Ort liegen. Die Schweiz nutzte ihr Wasser, 1879 nahm das Hotel Engadiner Kulm in St. Moritz die erste elektrische Beleuchtungsanlage des Landes in Betrieb. Bis etwa 1910 hatte das Land weltweit die höchste Stromproduktion pro Einwohner und 1939 waren 77 Prozent des Schienennetzes elektrifiziert, im übrigen Europa erst 5 Prozent. Google schätzte 2025 den Strom für eine mittlere Textanfrage an seine KI Gemini auf 0,24 Wattstunden, weniger als neun Sekunden Fernsehen. Gemessen hat das der Konzern selbst und das Training der Modelle kommt dazu.

### Elektrizität wird nutzbar · mittlere Textanfrage an seine KI Gemini

- **Kennung:** `PP-3342ef` (Vertiefung «Mehr lesen»)
- **Quelle:** [Google Cloud Blog, 21. August 2025: «Measuring the environmental impact of AI inference» (englisch)](https://cloud.google.com/blog/products/infrastructure/measuring-the-environmental-impact-of-ai-inference)
- **Fundstelle:** «We estimate the median Gemini Apps text prompt uses 0.24 watt-hours (Wh) of energy», «equivalent to watching TV for less than nine seconds». Datengrundlage Mai 2025, eingerechnet sind auch Kühlung und Rechenzentrums-Overhead. Der Konzern misst sich selbst, darum steht die Zahl im Text ausdrücklich als Googles Schätzung. «Median» heisst, die Hälfte der Anfragen brauchte mehr.
- **Geprüft:** 2026-08-17

> Voltas Batterie war ein Stapel aus Kupfer- und Zinkplättchen, dazwischen lag Pappe, die mit einer leitenden Flüssigkeit getränkt war. Wegen dieser Schichtung heisst sie Voltasche Säule. Er entwickelte sie um 1799 und stellte sie 1800 der Royal Society in London vor, jahrzehntelang blieben solche Batterien die wichtigste Stromquelle für Forschung und Technik. Ab 1832 kamen erste Magnetmaschinen dazu und nachdem Werner von Siemens 1866 das dynamoelektrische Prinzip entdeckt hatte, lieferten Dynamos Strom in industriellen Mengen. Am 4. September 1882 eröffnete Edison in New York die Pearl Street Station, zuerst mit einigen Dutzend Kunden, binnen zwei Jahren waren es über 500. Danach stritten Gleich- und Wechselstrom um die Zukunft. Den Ausschlag gab 1891 ein Versuch, bei dem Drehstrom von Lauffen am Neckar über 176 Kilometer nach Frankfurt floss und drei Viertel der Energie ankamen. Kraftwerk und Verbraucher mussten von da an nicht mehr am selben Ort liegen. Die Schweiz nutzte ihr Wasser, 1879 nahm das Hotel Engadiner Kulm in St. Moritz die erste elektrische Beleuchtungsanlage des Landes in Betrieb. Bis etwa 1910 hatte das Land weltweit die höchste Stromproduktion pro Einwohner und 1939 waren 77 Prozent des Schienennetzes elektrifiziert, im übrigen Europa erst 5 Prozent. Google schätzte 2025 den Strom für eine mittlere Textanfrage an seine KI Gemini auf 0,24 Wattstunden, weniger als neun Sekunden Fernsehen. Gemessen hat das der Konzern selbst und das Training der Modelle kommt dazu.

### Kabel verbinden die Kontinente · 1837 doppelt

- **Kennung:** `PP-3e54ff` (Vertiefung «Mehr lesen»)
- **Quelle:** [Elektrischer Telegraf (Wikipedia)](https://de.wikipedia.org/wiki/Elektrischer_Telegraf)
- **Fundstelle:** «Die beiden englischen Erfinder William Cooke (1806–1879) und Charles Wheatstone (1802–1875) entwickelten im Jahr 1837 einen Nadeltelegrafen», und Morse «hatte im Jahr 1837 einen elektromagnetischen Schreibtelegrafen erfunden». Zwei unabhängige Erfindungen im selben Jahr, darum «doppelt». Zur englischen Bahnlinie von 1839 sagt der Artikel nichts, sie bleibt darum draussen.
- **Geprüft:** 2026-08-17
...
- **Fundstelle:** 5. November 2024, Börsenwert 3,4 Billionen Dollar. Im Juni 2024 stand Nvidia schon einmal an der Spitze, konnte den Platz aber nur einen Tag halten. Darum «zeitweise».
- **Geprüft:** 2026-07-26
...
### Energie und Ressourcen · 48 Prozent

- **Kennung:** `VA-0210fd` (Fallbeispiel)
- **Quelle:** [ingenieur.de zum Google-Umweltbericht 2024](https://www.ingenieur.de/technik/fachbereiche/umwelt/energiehungrige-google-ki-treibt-emissionen-um-48-in-die-hoehe/)
- **Fundstelle:** «Treibhausgasemissionen in den letzten fünf Jahren um 48 % zugenommen haben, was hauptsächlich auf den hohen Stromverbrauch der Rechenzentren und der Lieferkette zurückzuführen ist.»
- **Geprüft:** 2026-07-26
...
### Rechenzentren · irische Statistikamt
...
- **Kennung:** `VA-aff821` (Fallbeispiel)
- **Quelle:** [Klarna, Medienmitteilung vom 27. Februar 2024](https://www.klarna.com/international/press/der-ki-kundenassistent-von-klarna-bearbeitet-im-ersten-monat-zwei-drittel-aller-kundendienst-anfragen/)
- **Fundstelle:** Klarnas eigene Angabe: Der KI-Assistent führte 2,3 Millionen Unterhaltungen, zwei Drittel aller Kundendienst-Chats und leiste damit die Arbeit von 700 Vollzeitmitarbeitenden. Unabhängig nachgemessen wurde das nicht.
- **Geprüft:** 2026-07-26
...
### Technologisch-kapitalistische Organisation · OpenAI Group PBC

- **Kennung:** `VA-7dc30e` (Fallbeispiel)
- **Quelle:** [OpenAI (Wikipedia)](https://de.wikipedia.org/wiki/OpenAI)
- **Fundstelle:** Umstrukturierung im Oktober 2025: «OpenAI Group PBC», die in «OpenAI Foundation» umbenannte Non-Profit hält 26 Prozent der Anteile. Microsoft ist grösster Einzelinvestor, aber nur nicht-stimmberechtigter Beobachter im Verwaltungsrat.
- **Geprüft:** 2026-07-26
...
- **Kennung:** `VA-282d51` (Bildgeschichte)
...
- **Kennung:** `VA-803b94` (Vertiefung «Mehr lesen»)
...
- **Kennung:** `VA-1169fe` (Bildgeschichte)
...
- **Kennung:** `VA-3e6316` (Vertiefung «Mehr lesen»)
...
- **Kennung:** `VA-e53161` (Vertiefung «Mehr lesen»)
...
- **Kennung:** `VA-e41918` (Bildgeschichte)
...
- **Kennung:** `EP-d33896` (Vertiefung «Mehr lesen»)
...
- **Kennung:** `EP-ddde72` (Vertiefung «Mehr lesen»)
- **Quelle:** [Plünderung Roms (410) (Wikipedia)](https://de.wikipedia.org/wiki/Pl%C3%BCnderung_Roms_(410))
...
- **Kennung:** `EP-112f69` (Vertiefung «Mehr lesen»)
...
- **Kennung:** `EP-ba3edc` (Vertiefung «Mehr lesen»)
- **Quelle:** [Sokrates (Wikipedia)](https://de.wikipedia.org/wiki/Sokrates)
...
- **Kennung:** `EP-b390cc` (Vertiefung «Mehr lesen»)
...
- **Kennung:** `EP-f9ae19` (Vertiefung «Mehr lesen»)
...
- **Kennung:** `EP-cada84` (Vertiefung «Mehr lesen»)
...
- **Kennung:** `EP-c6ae89` (Vertiefung «Mehr lesen»)
- **Quelle:** [Maschinenstürmer (Wikipedia)](https://de.wikipedia.org/wiki/Maschinenst%C3%BCrmer)
...
- **Kennung:** `EP-30fb42` (Vertiefung «Mehr lesen»)
...
- **Kennung:** `EP-bf8bae` (Vertiefung «Mehr lesen»)
...
- **Kennung:** `EP-5b7d88` (Vertiefung «Mehr lesen»)
...
- **Kennung:** `EP-588f72` (Vertiefung «Mehr lesen»)
- **Quelle:** [Erdüberlastungstag (Wikipedia)](https://de.wikipedia.org/wiki/Erd%C3%BCberlastungstag)
- **Fundstelle:** Definition: der Tag, «an dem die menschliche Nachfrage nach nachwachsenden Rohstoffen das Angebot und die Kapazität der Erde zur Reproduktion dieser Ressourcen in diesem Jahr übersteigt». In der Jahrestabelle steht für 1971 der 20. Dezember; zu 2025: «Im Jahr 2025 lag der Tag am 24. Juli, das war der früheste Termin seit Beginn der Berechnungen.»
- **Geprüft:** 2026-08-05
...
### Jetzt: Umwelt & KI · am 30. Juli, kam allerdings nicht von sparsamerem Leben

- **Kennung:** `EP-588f72` (Vertiefung «Mehr lesen»)
- **Quelle:** [Erdüberlastungstag (Wikipedia)](https://de.wikipedia.org/wiki/Erd%C3%BCberlastungstag)
- **Fundstelle:** Wörtlich: «Für das Jahr 2026 wurde der 30. Juli als Erdüberlastungstag berechnet. Das im Vergleich zu den Vorjahren spätere Datum resultierte aber nicht aus einer nachhaltigeren Lebensweise, sondern beruhte auf aktualisierten Daten zu dessen Berechnung, die vor allem eine höhere Aufnahmefähigkeit der Ozeane für Kohlenstoff [ergaben].»
- **Geprüft:** 2026-08-05

> Der Traum hinter dieser Technik ist uralt: Die griechische Sage erzählt vom Bronzeriesen Talos, der Kretas Küste bewachte, die Prager Legende vom Golem aus Lehm und 1818 liess Mary Shelley ihren Doktor Frankenstein ein künstliches Wesen erschaffen, das seinem Schöpfer entglitt. Der Fachbegriff stand 1955 erstmals im Antrag für eine Sommer-Werkstatt über «artificial intelligence» am Dartmouth College; der Antrag hielt grosse Fortschritte binnen weniger Monate für möglich und 1956 kam die kleine Forschergruppe dort zusammen. Stattdessen folgten Jahrzehnte, in denen die Erwartungen mehrfach zusammenbrachen, man spricht von «KI-Wintern». Umso abrupter kam der Durchbruch im Alltag: ChatGPT erreichte nach dem Start Ende 2022 innert rund zwei Monaten gegen hundert Millionen Nutzerinnen und Nutzer, schneller als jede Verbraucher-Anwendung zuvor. Hinter der mühelosen Oberfläche stehen allerdings sehr irdische Anlagen, Rechenzentren, deren Strom- und Wasserbedarf mit dem ganzer Städte verglichen wird. Dass diese Technik als körperloses Gegenüber erscheint, ist vielleicht ihre grösste Täuschung. Ähnlich unsichtbar bleibt, was unser Verbrauch kostet. Der Erdüberlastungstag benennt den Tag, an dem die Menschheit aufgebraucht hat, was die Erde in einem Jahr nachliefern kann: 1971 fiel er auf den 20. Dezember, 2025 auf den 24. Juli. Dass er 2026 wieder etwas später lag, am 30. Juli, kam allerdings nicht von sparsamerem Leben, sondern von neu berechneten Daten. Wie es aussieht, wenn die Rechnung nicht aufgeht, lässt sich vor der Haustür ablesen: Das Volumen der Schweizer Gletscher hat sich zwischen 1931 und 2016 halbiert, und von 2016 bis 2022 kamen weitere zwölf Prozent Verlust dazu.

### Jetzt: Umwelt & KI · weitere zwölf Prozent Verlust

- **Kennung:** `EP-588f72` (Vertiefung «Mehr lesen»)
- **Quelle:** [Gletscherschwund seit 1850 (Wikipedia)](https://de.wikipedia.org/wiki/Gletscherschwund_seit_1850)
- **Fundstelle:** Wörtlich: «Gemäss einer Studie der ETH Zürich hat sich das Volumen der Gletscher in der Schweiz zwischen 1931 und 2016 halbiert. Von 2016 bis 2022 haben die Gletscher laut dem Schweizerischen Gletschermessnetz (GLAMOS) weitere 12 Prozent an Volumen verloren.»
- **Geprüft:** 2026-08-05
...
### Jetzt: Umwelt & KI · das Methan der Viehhaltung und die Rodung der Wälder

- **Kennung:** `EP-2f2626` (Kartentext)
- **Quelle:** [Globale Erwärmung (Wikipedia)](https://de.wikipedia.org/wiki/Globale_Erw%C3%A4rmung)
- **Fundstelle:** Die Erwärmung wird «hauptsächlich durch Treibhausgase (Verbrennung von fossilen Energieträgern, Methanausstoß bei der Viehhaltung, Freisetzung von CO₂ bei der Zementherstellung) sowie durch die Rodungen von Waldgebieten verursacht».
- **Geprüft:** 2026-08-05
...
### Industriemoderne · Ab 1882 kommt der Strom aus zentralen Kraftwerken

- **Kennung:** `EP-379430` (Kartentext)
- **Quelle:** [Thomas Alva Edison (Wikipedia)](https://de.wikipedia.org/wiki/Thomas_Alva_Edison)
- **Fundstelle:** «Am 4. September 1882 wurde mit der Pearl Street Station das erste Zentralkraftwerk der USA in der New Yorker Pearl Street eröffnet», zunächst mit 59 Abnehmern. Der Teppich-Punkt «Elektrizität wird nutzbar» erzählt das ausführlich, hier steht nur die Jahreszahl als Marke der Epoche.
- **Geprüft:** 2026-08-17
...
- **Kennung:** `DW-cec7c7` (Fallbeispiel)
...
- **Kennung:** `DW-843cd1` (Fallbeispiel)
...
- **Kennung:** `DW-3f2dc9` (Fallbeispiel)
...
- **Kennung:** `DW-12c6e0` (Fallbeispiel)
...
- **Kennung:** `DW-59de49` (Fallbeispiel)
...
- **Kennung:** `DW-0a1fd3` (Fallbeispiel)
...
- **Kennung:** `DW-2ed77c` (Fallbeispiel)
...
- **Kennung:** `DW-085483` (Fallbeispiel)
...
- **Kennung:** `DW-8501de` (Fallbeispiel)
...
- **Kennung:** `DW-1e220e` (Fallbeispiel)
...
- **Kennung:** `DW-137ba2` (Fallbeispiel)
...
- **Kennung:** `DW-29cb30` (Fallbeispiel)
